...
# Unit 5 Deliverable - Final Sprints

## Deployed Application
Our application is successfully deployed and can be accessed here:
[My Streamlit Service](https://my-streamlit-service-lpv2tbxtqq-uc.a.run.app/)

### 🚀 Planned Features

---

#### **User Workout History & Achievements** (Alexis)
**Total Story Points:** 13  
**Plan:** Focus on backend badge logic and schema work early in the week. Begin unit tests by Thursday.

- [x] **Design schema for storing user workout history & achievements** *(SP: 3, High)*
- [x] **Create badge logic for distance milestones (5K, 10K, etc.)** *(SP: 2, Medium)*
- [x] **Create badge logic for workout frequency (7-day, 30-day streaks)** *(SP: 2, Medium)*
- [x] **Create badge logic for personal bests (fastest mile, longest run)** *(SP: 2, Medium)*
- [x] **Track social engagement (shared post, 10 interactions)** *(SP: 2, Medium)*
- [x] **Unit test badge logic** *(SP: 2, Medium)*

---

#### **Workout Streaks & Achievement Display** (Neayla)
**Total Story Points:** 13  
**Plan:** Frontend UI first (Mon–Tues), backend streak logic midweek (Wed–Thurs), integrate and test by weekend.

- [x] **Build backend logic to track consecutive workout days** *(SP: 3, High)*
- [x] **Design user profile UI to display achievements** *(SP: 3, High)*
- [x] **Implement frontend components for badge display** *(SP: 2, High)*
- [x] **Integrate frontend with backend APIs for streak/badge updates** *(SP: 3, High)*
- [x] **Unit test workout streak logic** *(SP: 2, Medium)*

---

#### **Nutrition & Performance Tracking** (Stanley)
**Total Story Points:** 13  
**Plan:** Schema & analytics logic Mon–Wed, integration Thurs–Fri, testing by weekend.

- [x] **Design nutrition and meal logging database schema** *(SP: 3, High)*
- [x] **Implement water intake monitoring system** *(SP: 2, Medium)*
- [x] **Build analytics feature to correlate nutrition with performance** *(SP: 3, High)*
- [x] **Integrate frontend UI with backend nutrition tracking APIs** *(SP: 3, High)*
- [x] **Write unit tests for nutrition backend logic** *(SP: 2, Medium)*

---

#### **Meal Logging & Calorie Goals** (Diego)
**Total Story Points:** 9  
**Plan:** UI and calorie logic early in week, backend middle, test on Friday.

- [x] **Build backend logic to log meals and nutrients** *(SP: 3, High)*
- [x] **Create UI for daily meal logging and macronutrient input** *(SP: 2, Medium)*
- [x] **Add functionality for setting and tracking calorie goals** *(SP: 2, Medium)*
- [x] **Write unit tests for frontend meal logging and UI interactions** *(SP: 2, Medium)*
